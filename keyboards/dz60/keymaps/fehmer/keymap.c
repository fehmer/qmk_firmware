...
TD(TD_ESC_CAPS), KC_1,     KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,  KC_BSPC,
    ...
    OSM_LCTL,    OSM_LGUI, OSM_LALT,                        KC_SPC,                                OSM_RALT, OSM_RGUI, FNL,     OSM_RCTL
  ),
   ...
   * |-----------------------------------------------------------|
   * |      |CT1|MSD|MSR|MWD|   |   |PGU|LFT|DWN|RGT|APP|INS|    |
   * |-----------------------------------------------------------|
   * |    |   |   |   |   |   |   |   |PGD|HOM|END|   |          |
   * |-----------------------------------------------------------|
   * |    |    |    |                        |    |RESET|    |   |
  ...
  [_FN] = LAYOUT_60_iso(
    ...
    _______,  C(KC_1), KC_MS_D, KC_MS_R, KC_WH_D, _______, _______, KC_PGUP, KC_LEFT, KC_DOWN, KC_RIGHT, KC_APP,  KC_INS , _______,
