...
[_RAISE] = LAYOUT_planck_grid(
    KC_GRV,  KC_EXLM,       KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR,    KC_LPRN,   KC_RPRN,  ALGR(KC_MINS),
...
[_FN] = LAYOUT_planck_grid(
    ...
    _______, KC_QUOT, _______, _______, _______, _______, KC_PGUP, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,
