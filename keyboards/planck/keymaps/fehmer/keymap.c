 ...
 * |      |  F1  |  F2  |  F3  |  F10 |      |      |   1  |   2  |   3  |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Print|Scroll|Pause |      |             |   0  |   ,  |   .  |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_planck_grid(
    KC_GRV,  KC_F7,   KC_F8,   KC_F9,   KC_F12,  _______, _______,     KC_7,    KC_8,    KC_9,   S(KC_MINS), KC_DEL,
    ...
    _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, _______,     KC_0,    KC_COMM, KC_DOT, _______,    _______
),
